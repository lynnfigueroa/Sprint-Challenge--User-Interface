...
Semantic HTML adds meaning to the page, instead of just using
divs for everything.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
A block element starts on a new line and extends all the way
across the page, and an inline element does not.
...
Git is valuable because it allows a team of developers to create
different branches and work on a project at the same time.
